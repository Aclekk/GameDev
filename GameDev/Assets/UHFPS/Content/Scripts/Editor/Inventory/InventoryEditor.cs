...
{
    [CustomEditor(typeof(UHFPS.Runtime.Inventory))]
    public class InventoryEditor : InspectorEditor<UHFPS.Runtime.Inventory>
    {
        public override void OnInspectorGUI()
        {
            ...
            if (EditorDrawing.BeginFoldoutBorderLayout(new GUIContent("Starting Items"), ref siExpanded))
            {
                ...
                {
                    Target.startingItems.Add(new UHFPS.Runtime.Inventory.StartingItem());
                }
